...
export default function Home() {
  ...
  return <main id="top">
    ...
    <section className="room-guide" id="guide" data-reveal>
      <div className="room-collage"><figure className="room-main"><img src="/images/project-08.jpeg" alt="Warm Venetian blinds controlling daylight" /><figcaption>Warm light / Venetian</figcaption></figure><figure className="room-small"><img src="/images/project-10.jpeg" alt="Grey roller blinds in a clean interior" /><figcaption>Quiet privacy / Roller</figcaption></figure><span className="orbit-label">LIGHT<br />CONTROL</span></div>
